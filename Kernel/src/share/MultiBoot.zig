...
//custom
pub const struct_multiboot_elf_header = extern struct {
    magic: i32 = @import("std").mem.zeroes(multiboot_uint32_t),
    flags: i32 = @import("std").mem.zeroes(multiboot_uint32_t),
    checksum: i32 = @import("std").mem.zeroes(multiboot_uint32_t),
};