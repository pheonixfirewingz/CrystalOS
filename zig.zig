...
pub const __builtin_mul_overflow = @import("std").zig.c_builtins.__builtin_mul_overflow; // ./../c.c:2:3: warning: TODO implement translation of stmt class GCCAsmStmtClass
// ./../c.c:1:20: warning: unable to translate function, demoted to extern
pub extern fn outb(arg_port: c_ushort, arg_val: u8) callconv(.C) void; // ./../c.c:13:3: warning: TODO implement translation of stmt class GCCAsmStmtClass
// ./../c.c:11:29: warning: unable to translate function, demoted to extern
pub extern fn inb(arg_port: c_ushort) callconv(.C) u8;
